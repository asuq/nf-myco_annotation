...
workflow {
    ...
    log.warn 'Several DSL2 wrappers are now wired, but taxonomy expansion, ANI input building, sample-status assembly, and final version collection remain incomplete.'
}
