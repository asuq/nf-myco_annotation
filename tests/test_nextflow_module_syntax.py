...
class NextflowModuleSyntaxTestCase(unittest.TestCase):
    ...
    def test_runtime_database_prep_modules_delegate_to_python_helpers(self) -> None:
        ...
        self.assertIn('patched_script="\\$PWD/download_eggnog_data.py.patched"', eggnog_module_text)
        self.assertNotIn('patched_script="${PWD}/download_eggnog_data.py.patched"', eggnog_module_text)
